    ...
    <footer className="bg-[var(--bg-black)] border-t border-white/10 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.a
          ...
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="fixed bottom-6 right-6 bg-[var(--neon-pink)] text-white px-4 py-2 rounded-full text-sm font-bold shadow-[0_0_20px_var(--neon-pink)] z-40 hidden md:flex items-center gap-2"
        >
          <span>Enter Only Foam Club</span>
