...
const longsleeves = products.filter(p => p.category === 'longsleeve');
...
export default function LongsleevesPage() {
  ...
  const filteredProducts = longsleeves.filter(p =>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <ScrollReveal variant="fadeUp" delay={0.3}>
            <p className="text-[var(--text-grey)] text-lg">
              Premium longsleeve shirts for the job site and beyond.
            </p>
          </ScrollReveal>
        </div>
        ...
        {filteredProducts.length === 0 && (
          <div className="text-center py-20">
            <p className="text-[var(--text-grey)] text-lg mb-4">No longsleeves found for this filter.</p>
            <MagneticButton onClick={() => setSelectedBrand('all')} variant="primary">
              Show All Longsleeves
            </MagneticButton>
          </div>
        )}
        ...
        <ScrollReveal variant="fadeUp" delay={0.3}>
          <div className="mt-16 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <MagneticButton href="/shop/hoodies" variant="primary">
                Hoodies
              </MagneticButton>
