...
const vegasProducts: Product[] = [
  {
    ...
    slug: 'vegas-hoodie-2026',
    description: 'Exclusive Vegas 2026 convention hoodie. Limited edition design.',
    basePrice: 53.00,
    category: 'hoodie',
    brand: 'vegas',
    image: '/images/Hoodies/Blue-Sprayfoam-Hoodie-FE.webp',
    images: ['/images/Hoodies/Blue-Sprayfoam-Hoodie-FE.webp'],
  ...
  },
  {
    ...
    category: 'tshirt',
    brand: 'vegas',
    image: '/images/DONE/LasVegas-Preview.webp',
    images: ['/images/DONE/LasVegas-Preview.webp'],
    sizes: ['SM', 'M', 'L', 'XL', '2XL', '3XL'],
    colors: ['black'],
    inStock: true,
    isPreorder: true,
  ...
  },
  {
    ...
    slug: 'vegas-longsleeve-2026',
    description: 'Premium Vegas 2026 longsleeve shirt.',
    basePrice: 34.00,
    category: 'longsleeve',
    brand: 'vegas',
    image: '/images/Hoodies/SprayFoam-Hoodie-FE.webp',
    images: ['/images/Hoodies/SprayFoam-Hoodie-FE.webp'],
    sizes: ['SM', 'M', 'L', 'XL', '2XL', '3XL'],
    colors: ['black'],
    inStock: true,
    isPreorder: true,
