...
export default function TShirtsPage() {
  ...
  const filteredProducts = tshirts.filter(p =>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <ScrollReveal variant="fadeUp" delay={0.3}>
            <p className="text-[var(--text-grey)] text-lg">
              Rep the spray foam industry with premium tees.
            </p>
          </ScrollReveal>
        </div>
        ...
        {filteredProducts.length === 0 && (
          <div className="text-center py-20">
            <p className="text-[var(--text-grey)] text-lg mb-4">No t-shirts found for this filter.</p>
